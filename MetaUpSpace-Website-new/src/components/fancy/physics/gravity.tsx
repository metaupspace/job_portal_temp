  ...
  (
    ...
    const registerElement = useCallback(
      (id: string, element: HTMLElement, props: MatterBodyProps) => {
        ...
        // ✅ FINAL FIX: Create safe body options by filtering and transforming
        const safeBodyOptions = props.matterBodyOptions ? 
          Object.fromEntries(
            Object.entries(props.matterBodyOptions)
              .filter(([, value]) => value !== null)
              .map(([key, value]) => [key, value === null ? undefined : value])
          ) : {}

        const finalBodyOptions = {
          ...safeBodyOptions,
          angle: angle,
          render: {
        ...
        if (props.bodyType === "circle") {
          ...
          body = Bodies.circle(x, y, radius, finalBodyOptions)
          ...
          body = Bodies.fromVertices(x, y, vertexSets, finalBodyOptions)
        } else {
          body = Bodies.rectangle(x, y, width, height, finalBodyOptions)
        }
